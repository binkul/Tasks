...
public class TrelloClient {
    ...
    public List<TrelloBoardDto> getTrelloBoards() {
        ...
        try {
            ...
            LOGGER.info("Request for all Boards from trello.");
    ...
    public CreatedTrelloCardDto createNewCard(TrelloCardDto trelloCardDto) {
        return restTemplate.postForObject(getUrlForPost(trelloCardDto), null, CreatedTrelloCardDto.class);
    }

    private URI getUrlForGet() {
        return UriComponentsBuilder.fromHttpUrl(trelloConfig.getTrelloApiEndpoint())
                .pathSegment("members")
                .pathSegment(trelloConfig.getTrelloUsername())
                .pathSegment("boards")
